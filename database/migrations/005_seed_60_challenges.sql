...
INSERT INTO challenges (zone, difficulty, title, description, estimated_time, implementation_trigger, implementation_action, identity_frame, meaning_connection, evidence_type, is_active) VALUES
...
INSERT INTO challenges (zone, difficulty, title, description, estimated_time, implementation_trigger, implementation_action, identity_frame, meaning_connection, evidence_type, is_active) VALUES
('physical', 'low', 'Take a Cold Shower (Last 30 Seconds)', 'End your shower with 30 seconds of cold water. Breathe through it without leaving early.', 5, 'When I''m in the shower', 'I will turn the water to cold for the last 30 seconds and stay present', 'People who honor their bodies don''t avoid discomfort—they lean into it', 'Cold exposure trains your nervous system. You''re building physical resilience.', 'text', true),
